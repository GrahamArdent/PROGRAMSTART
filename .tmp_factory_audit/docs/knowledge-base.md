...
4. **Schema Validation**: `programstart-retrieval validate` verifies the KB conforms to the Pydantic `KnowledgeBase` model with `StackEntry`, `IntegrationPattern`, and `RetrievalGuidance` submodels
