    ...
    if capability:
        ...
        return {
            ...
            "retrieval_guidance": {
                ...
                for key, values in index["knowledge_base"].get("retrieval_guidance", {}).items()
...
def cached_index_is_compatible(index: dict[str, Any]) -> bool:
    return "knowledge_base" in index and isinstance(index["knowledge_base"], dict)
